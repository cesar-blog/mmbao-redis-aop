package com.mmbao.redis.util.page.dialect;
...
public class OracleDirectPagetionPlugin extends PluginAdapter {
	...
	private void addPage(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String name) {
		topLevelClass.addImportedType(new FullyQualifiedJavaType("com.cableex.core.util.page.Page"));
		CommentGenerator commentGenerator = context.getCommentGenerator();
		Field field = new Field();
		field.setVisibility(JavaVisibility.PROTECTED);
		field.setType(new FullyQualifiedJavaType("com.cableex.core.util.page.Page"));
		field.setName(name);
		...
		method.addParameter(new Parameter(new FullyQualifiedJavaType("com.cableex.core.util.page.Page"), name));
		method.addBodyLine("this." + name + "=" + name + ";");
		commentGenerator.addGeneralMethodComment(method, introspectedTable);
		topLevelClass.addMethod(method);
		method = new Method();
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setReturnType(new FullyQualifiedJavaType("com.cableex.core.util.page.Page"));
